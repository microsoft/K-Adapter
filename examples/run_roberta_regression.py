...
def load_and_cache_examples(args, task, tokenizer, dataset_type, evaluate=False):
    ...
    if os.path.exists(cached_features_file):
        ...
        features = convert_examples_to_features_sec(examples, args.max_seq_length, tokenizer, output_mode,
...
def train(args, train_dataset, model, tokenizer):
    ...
    optimizer = AdamW(pretrained_model.parameters(), lr=args.learning_rate, eps=args.adam_epsilon)
...
def main():
    ...
    tokenizer = RobertaTokenizer.from_pretrained('roberta-large', model_max_length=args.max_seq_length)
